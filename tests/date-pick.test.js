...
await p.click(`.calg button:text-is("5")`); await p.waitForTimeout(350);
T('고르면 달력이 닫힌다', !(await p.$('.calg')));
...
await p.click(`.calg button:text-is("3")`); await p.waitForTimeout(300);
